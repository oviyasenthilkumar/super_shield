...
const ProductLines = () => {
  ...
  return (
    <section className="w-full bg-[#f7f7f7] py-12 px-4 md:px-8 lg:px-16">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-3xl md:text-4xl font-semibold text-black text-center mb-8 poppins ">
          Product Lines
        </h2>
          ...
          {itemsToRender.map((item, index) => (
            ...
            >
              ...
              <div className="p-4 flex-grow flex flex-col justify-between">
                <h4 className="font-semibold text-black mb-1 text-left open-sans text-2xl">
                  {item.title}
                </h4>
                <p className=" text-[#515050] text-left open-sans font-normal text-lg">
                  {item.description}
                </p>
              </div>
            </div>
