...
export default function Admix300Hero() {
  return (
    <div className=" bg-white flex flex-col justify-center px-4 md:px-20 py-10 ">
      <div className="flex flex-col lg:flex-row gap-10 items-center max-w-7xl mx-auto px-3 md:px-0">
        ...
        <div className="w-full lg:w-[60%]">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 leading-10 poppins">
            <span className="text-[#C50022]">Supershield</span> ADMIX 300
          </h1>
          ...
          <p className="text-gray-700 text-justify md:leading-7 space-y-2 open-sans leading-6 text-sm md:text-base">
            ...
            SUPERSHIELD ADMIX 300 is specially designed for waterproofing
            concrete with self-healing properties, this admixture is
            specifically formulated for ready-mix concrete (RMC) plant mixes and
            is ideal for projects requiring extended retardation.
          </p>
        </div>
      </div>
    </div>
