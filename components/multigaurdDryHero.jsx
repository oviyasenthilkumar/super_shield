...
export default function MultigaurdDryHero() {
  return (
    <div className=" bg-white flex flex-col justify-center px-4 md:px-20 py-10 ">
      <div className="flex flex-col lg:flex-row gap-10 items-center max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-[60%]">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 leading-8 md:leading-10 poppins">
            <span className="text-[#C50022]">Supershield</span> Multiguard
          </h1>
          ...
          <p className="text-gray-700 text-justify leading-7 open-sans mb-4">
