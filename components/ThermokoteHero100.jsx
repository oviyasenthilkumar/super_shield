...
export default function ThermokoteHero100() {
  return (
    <div className=" bg-white flex flex-col justify-center px-4 md:px-20 py-10 ">
      <div className="flex flex-col lg:flex-row gap-10 items-center max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-[60%]">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 leading-7 md:leading-9 poppins">
            <span className="text-[#C50022]">Supershield</span> THERMOKOTE 100
          </h1>
          <h2 className="text-xl md:text-2xl font-semibold mb-6 text-gray-800 leading-7 md:leading-8 poppins">
            Thermal Insulation and Protective Coatings for Roofs
          </h2>
          <p className="text-gray-700 text-justify md:leading-7 space-y-2 open-sans leading-6">
            SUPERSHIELD THERMOKOTE is a one-component waterborne liquid applied
            insulation coating with high reflectivity, emissivity, and very low
            conductivity. It is designed to insulate both hot and cold in a
            single application. SUPERSHIELD THERMOKOTE is installed just like
            any other coating products with a brush or a spraying machine. Once
            installed, the coating becomes a seamless continuous monolithic
            membrane, which provides not only insulation but also acts a
            waterproof, fire-resistant, and noise reduction system. SUPERSHIELD
            THERMOKOTE is a highly durable flexible coating developed from
            advanced resins that are based on CROSSLINK Technology and filled
            with formulated vacuumed multi ceramic molecules. SUPERSHIELD
            THERMOKOTE is further enhanced with Enviro-Stable film technology
      ...
      <div className="max-w-7xl mx-auto">
        <h2 className="text-xl md:text-2xl font-semibold mb-6 space-y-2 mt-10 text-gray-800 poppins">
