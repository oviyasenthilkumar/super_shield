...
const relatedProducts = [
  {
    name: "THERMOKOTE 100",
    image: "/thermokote100.webp",
    description:
      "One-component waterborne liquid applied insulation coating for roofs with high reflectivity, emissivity, and very low conductivity.",
    href: "/THERMOKOTE-100",
  },
  {
    name: "THERMOKOTE 200",
    image: "/thermokote200.webp",
    description:
      "One-component waterborne liquid-applied insulation coating for walls with high reflectivity, emissivity, and very low conductivity.",
    href: "/THERMOKOTE-200",
  },
  {
    name: "THERMOKOTE 300",
    image: "/thermokote300.webp",
    description:
      "One-component waterborne liquid-applied insulation coating with high reflectivity, emissivity, and very low conductivity.",
    href: "/THERMOKOTE-300",
  },
];

export default function ThermokoteProducts() {
  return (
