...
export default function ProgrammedCracks() {
  return (
    <div
      id="cracks"
    ...
    >
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-[60%]">
          <h1 className="text-2xl md:text-3xl font-semibold leading-10 mb-4 poppins">
            4. PROGRAMMED CRACKS
          </h1>
          <p className=" text-gray-700 space-y-4 text-justify open-sans leading-7 text-sm md:text-base ">
            ...
            movement joints. Programmed Cracks are planned cracks that add a
            weak point in the concrete slab and force the small crack to form
            along the cut rather than appear as a random crack at some more
            obvious point, and this also allows the release of the additional
      ...
      <div className="bg-gray-50 mt-10 p-6  shadow-sm">
        ...
        <Accordion
          ...
          content="Supershield PANELSTOP CI is a Steel panel waterstop that is rubber coated with swellable lining on crack inducing element."
          imageSrc="/Programmedcracks1.webp"
