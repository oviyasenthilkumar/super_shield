    ...
    >
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="w-full lg:w-[60%]">
          ...
          <p className=" text-gray-700 space-y-4 text-justify open-sans leading-7 text-sm md:text-base ">
            Supershield SWELLPLUG and SWELLRING are easy and secure ways of
            sealing around all types of formwork spacers (Round and Square).
            Different sizes are available for the most common spacers. The
            SWELLPLUG seals the inner ring, whereas the SWELLRING seals around
      ...
      <div className="bg-gray-50 mt-10 p-6  shadow-sm">
        ...
        <Accordion
          ...
          content="Supershield SWELLPLUG is a Swellable Hydrophilic waterstop that forms a compression seal inside or around the Form Tie holes in the concrete structure."
          imageSrc="/FORMWORK1.webp"
          readMoreLink="/expansionjoint/Swellstop"
        />

        <Accordion
          title="Supershield SWELLRING"
          content="Supershield SWELLRING is a Swellable waterstop ring to seal tie rods and pipe penetrations in concrete."
          imageSrc="/FORMWORK2.webp"
          readMoreLink="/expansionjoint/Swellstop"
        />
      </div>
      ...
      <div className="mt-8 text-right">
        <button
          ...
          className="relative overflow-hidden border border-gray-800 px-4 py-2 text-sm text-gray-800 transition duration-300 group hover:border-[#C50022] "
        >
