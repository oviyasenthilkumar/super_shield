...
export default function Admix100Hero() {
  return (
    <div className=" bg-white flex flex-col justify-center px-4 md:px-20 py-10 ">
      <div className="flex flex-col lg:flex-row gap-10 items-center max-w-7xl mx-auto px-3 md:px-0">
        ...
        <div className=" w-full md:w-[60%] px-3 md:px-0">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold mb-4 leading-10 md:leading-8 poppins ">
            <span className="text-[#C50022]">Supershield</span> ADMIX 100
          </h1>
          ...
          <p className="text-gray-700 text-justify md:leading-7 space-y-2 open-sans leading-6 text-sm md:text-base">
            SUPERSHIELD ADMIX 100 is a chemical admixture for waterproofing,
            protecting and improving the durability of concrete. The proprietary
            blend of chemicals in SUPERSHIELD ADMIX 100 reacts with the moisture
            ...
            SUPERSHIELD ADMIX 100 is specifically formulated to meet modern
            concrete practices that incorporate additives such as fly ash and
            slag.
          </p>
        </div>
      </div>
